...
public class ValveDetailActivity extends AppCompatActivity {
    ...
    private static final String TAG = "ValveDetail";
    private EquipDAO ED;
    ...
    private void initData() {
        ...
        myInforHandler = new MyInforHandler() {
            ...
            protected void operationSuccess() {
              //  Toast.makeText(ValveDetailActivity.this,getResources().getString(R.string.operation_success),Toast.LENGTH_SHORT).show();
            }
...
//                Toast.makeText(ValveDetailActivity.this,"operation failed",Toast.LENGTH_LONG).show();
                myInforHandler.sendEmptyMessage(GETBACK_FAILED);
            }

            @Override
            protected void sendEquipmentDataSuccess() {
//                Toast.makeText(ValveDetailActivity.this,"operation success",Toast.LENGTH_LONG).show();
    ...
    private void chuli(int num1) {
        ...
        if (device.getState() == null || "".equals(device.getState()) || device.getState().length() != 8) {
            ...
            String aaa = "01" + status2 +"ff"+"ff";//目前固定使用01
