 ...
 * Demo: 修改设备密码
 */
public class ActivityGuideDeviceChangePassw extends TopbarIpcSuperActivity implements View.OnClickListener, OnFunDeviceOptListener {
	...
	protected void onCreateInit() {
		...
		textView_title.setText(getResources().getString(R.string.device_setup_change_password));
