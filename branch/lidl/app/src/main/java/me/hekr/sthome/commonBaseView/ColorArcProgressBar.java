...
public class ColorArcProgressBar extends View
{
    ...
    private int middleLineColor  = 0xffcdcdcd;
...
//    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh)
    {
        ...
        if(isAutoTextSize)
        {
            textSize = (float) (diameter * 0.2);
            hintSize = (float) (diameter * 0.1);
            curSpeedSize = (float) (diameter * 0.1);
            hintSizeMax = (float) (diameter * 0.1);
            vTextPaint.setTextSize(textSize);
            vSubTextPaint.setTextSize(textSize);
...
//        vTextPaint.setTextSize(textSize);
        vTextPaint.setColor(Color.parseColor("#de6459"));
        vTextPaint.setTextAlign(Paint.Align.CENTER);

        //内容显示第二行文字
        vSubTextPaint = new Paint();
        vSubTextPaint.setColor(Color.parseColor("#0099ff"));
...
//        curSpeedPaint.setTextSize(curSpeedSize);
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        if(isNeedContent)
        {
            ...
            canvas.drawText(String.format("%.1f", currentValues)+"℃", centerX, centerY - textSize /2, vTextPaint);
        }
        canvas.drawText(String.format("%.0f", subCurrentValues)+"℃", centerX, centerY + textSize+textSize/4, vSubTextPaint);
        ...
        canvas.drawLine(centerX-diameter/2+diameter/6,centerY, centerX + diameter/2 - diameter/6,centerY,linePaint);
