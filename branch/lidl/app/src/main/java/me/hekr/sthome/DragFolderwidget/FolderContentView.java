...
public class FolderContentView extends View implements IPageView {
    ...
    public Point getIconLocation(int index) {
        ...
        point.x = (lc.getMarginLeft() + lc.gapH2 + j * (lc.getIconWidth() + lc.gapH2));
    ...
    public void hitTest3(int x, int y, HitTestResult3 hitTest3) {
        ...
        int y1 = top;
        int left = lc.marginLeft2 + lc.gapH2;
        ...
        for (int row = 0; row < rows; row++) {
            ...
            for (int column = 0; column < columns; column++) {
                ...
                x1 += lc.iconWidth + lc.gapH2;//转向下一列
            }
        ...
        for (int i = 0; i < rows; i++) {
            ...
            for (int j = 0; j < columns; j++) {
                ...
                if (x <= x1) {
                    ...
                    //应用里面
                    inType = 2;
                } else if (x > lc.iconWidth + x1 && x < (lc.iconWidth + x1 + lc.gapH2 / 2)) {
                    //应用右半边
                    inType = 1;
                }
    ...
    public boolean setMoveTo(int index) {
        ...
        if (index >= mInfo.getIcons().size()) {
            int i = oldIndex;
            drawback = mInfo.getIcons().size()+FRENSH_NUM;
    ...
    private void moveIcon(int from, int to, long offset) {
        ...
        if (app != null) {
            ...
            app.tAnim.initialize(lc.getItemWidth() + lc.gapH2, lc.getItemHeight(), getWidth(), getHeight());
