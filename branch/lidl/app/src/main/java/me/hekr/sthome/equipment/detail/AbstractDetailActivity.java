 ...
 */
public abstract class AbstractDetailActivity extends AppCompatActivity implements MultiDirectionSlidingDrawer.OnDrawerOpenListener,MultiDirectionSlidingDrawer.OnDrawerCloseListener {
        ...
        HekrUserAction.getInstance(this).getAlarmHistoryList(this, ConnectionPojo.getInstance().deviceTid, ConnectionPojo.getInstance().ctrlKey, ConnectionPojo.getInstance().propubkey, page, new HekrUser.GetDeviceHistoryListener() {
            ...
            public void getFail(int errorCode) {
                ...
                if(errorCode==1){
                    ...
                    Toast.makeText(getApplicationContext(), UnitTools.errorCode2Msg(getApplicationContext() ,errorCode),Toast.LENGTH_LONG).show();
                }
            }
        });
    }
