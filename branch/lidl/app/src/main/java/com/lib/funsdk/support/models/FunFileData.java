...
public class FunFileData {
	...
	public String toString() {
		return "FunFileData{" +
				"mCaptTempPath='" + mCaptTempPath + '\'' +
				", mFileName='" + mFileName + '\'' +
				", mFileType=" + mFileType +
				", mStreamType=" + mStreamType +
				", mFileBeginDate='" + mFileBeginDate + '\'' +
				", mFileBeginTime='" + mFileBeginTime + '\'' +
				", mFileEndDate='" + mFileEndDate + '\'' +
				", mFileEndTime='" + mFileEndTime + '\'' +
				", mFileData=" + mFileData +
				", mFileOpComPic=" + mFileOpComPic +
				'}';
	}
}
